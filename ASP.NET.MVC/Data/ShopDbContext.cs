...
namespace ASP.NET.MVC.Data
{
    public class ShopDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           {
                new Product() { Id = 1, Name = "iPhone X", Category = "Electronix", Discount = 10, Price = 650, ImageUrl = "https://applecity.com.ua/image/cache/catalog/0iphone/ipohnex/iphone-x-black-1000x1000.png" },
                ...
                new Product() { Id = 4, Name = "Samsung S23", Category = "Electronix", Discount = 5, Price = 1200, InStock = true, ImageUrl = "https://sota.kh.ua/image/cache/data/Samsung-2/samsung-s23-s23plus-blk-01-700x700.webp" },
                ...
                new Product() { Id = 6, Name = "MacBook Pro 2019", Category = "Electronix", Discount = 10, InStock = true, Price = 1200, ImageUrl = "https://newtime.ua/image/import/catalog/mac/macbook_pro/MacBook-Pro-16-2019/MacBook-Pro-16-Space-Gray-2019/MacBook-Pro-16-Space-Gray-00.webp" }
            });
        }
